...
- There are typically 2-3 servers for weekday lunches including head servers, and as many as five for Saturday.  The difference in number of checks per hour isn't large between Saturday and Friday, but the number of servers is.  Does Saturday lunch need so many servers and do other days need so few?
