---
title: "Exploratory Labor Analysis"
...
week.facet(dataset =labor.agg, job.or.all = "COOK", compare.sales = FALSE)
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height=4, fig.width=7.7}
setwd("C://Users/The Pritchard family/Documents/R/christophers/")
week.facet(dataset = labor.agg, job.or.all = "COOK", compare.sales = TRUE, dollars.checks.items = "dollars")
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height=4, fig.width=7.7}
setwd("C://Users/The Pritchard family/Documents/R/christophers/")
week.facet(dataset = labor.agg, job.or.all = "COOK", compare.sales = TRUE, dollars.checks.items = "items")
...
week.facet(dataset =labor.agg, job.or.all = "Manager", compare.sales = FALSE)
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height=4, fig.width=7.7}
setwd("C://Users/The Pritchard family/Documents/R/christophers/")
week.facet(dataset = labor.agg, job.or.all = "Manager", compare.sales = TRUE, dollars.checks.items = "dollars")
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height=4, fig.width=7.7}
setwd("C://Users/The Pritchard family/Documents/R/christophers/")
week.facet(dataset = labor.agg, job.or.all = "Manager", compare.sales = TRUE, dollars.checks.items = "checks")
...
week.facet(dataset =labor.agg, job.or.all = "SUPPORT STAFF", compare.sales = FALSE)
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height=4, fig.width=7.7}
setwd("C://Users/The Pritchard family/Documents/R/christophers/")
week.facet(dataset = labor.agg, job.or.all = "SUPPORT STAFF", compare.sales = TRUE, dollars.checks.items = "dollars")
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, fig.height=4, fig.width=7.7}
setwd("C://Users/The Pritchard family/Documents/R/christophers/")
week.facet(dataset = labor.agg, job.or.all = "SUPPORT STAFF", compare.sales = TRUE, dollars.checks.items = "checks")
